...
def scan_subdomains(target):
    ...
    if SUBLIST3R_AVAILABLE:
        ...
        try:
            ...
            print("[!] Sublist3r encountered an issue with parsing DNSDumpster response. Consider updating Sublist3r.")
        except Exception as e:
        ...
        if check_tool_installed("amass"):
            try:
                print(f"\n[+] Scanning for active subdomains of {target} using Amass...")
